...
import gr.aueb.coma_contrib.matchers.TzkNGramMatcher;
...
//	  public static final int SIM_STR_NAME         = Manager.MEAS_CNT + 20;
	...
	// DEFAULT
	  ...
	  public static final int SIM_STR_NGRAM_TZK = Constants.MEAS_CNT + 35;
...
//			SIM_STR_EDJOIN // onyl 0
	    ...
	    public static String measureToString(int measure) {
	        switch (measure) {
			  ...
			  case SIM_STR_NGRAM_TZK:      					return "NGramTzk";
	    ...
	    public static int stringToMeasure(String measure) {
            // // TODO: 2/11/16 may need to add tzk trigram here
			...
			else if (measure.equals("ngramtzk"))  return SIM_STR_NGRAM_TZK;
...
//		        	matcher =  new CosineSimmetrics("attr", "attr", 0.0f);
		        ...
		        case SIM_STR_COSINE_PPJOINPLUS://+
		        	...
		        	break;
                case SIM_STR_NGRAM_TZK:
                    matcher =  new TzkNGramMatcher("attr", "attr", DEFAULT_THRESHOLD);
                    break;
				}
